...
local OPENSSL_10 = require("openssl.version").OPENSSL_10
local OPENSSL_11_OR_LATER = require("openssl.version").OPENSSL_11_OR_LATER
local BORINGSSL = require("openssl.version").BORINGSSL
