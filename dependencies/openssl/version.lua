...
local LIBRESSL = version_text:find("LibreSSL", 1, true) ~= nil

if version_num >= 0x30000000 and not LIBRESSL then
  local info_table = {
...
return setmetatable({
    ...
    OPENSSL_30 = version_num >= 0x30000000 and not LIBRESSL,
    OPENSSL_11 = version_num >= 0x10100000 and version_num < 0x10200000 and not LIBRESSL,
    OPENSSL_111 = version_num >= 0x10101000 and version_num < 0x10200000 and not LIBRESSL,
    OPENSSL_11_OR_LATER = version_num >= 0x10100000 and not LIBRESSL,
    OPENSSL_111_OR_LATER = version_num >= 0x10101000 and not LIBRESSL,
    OPENSSL_10 = (version_num < 0x10100000 and version_num > 0x10000000) or LIBRESSL,
    LIBRESSL = LIBRESSL,
    BORINGSSL = BORINGSSL,
